...
<WebElementEntity>
   ...
   <name>body_Add Instructor                        _fc7de2</name>
   <tag></tag>
   <elementGuidId>74681600-fe09-4181-921b-4da8f40604c4</elementGuidId>
   <selectorCollection>
      <entry>
         <key>XPATH</key>
         <value>//body</value>
                ...
                if (r == true) {
                        ...
                        //waitingDialog.show('Loading....');
                         $.ajax({
                             ...
                             cache: false,
                             timeout:60000,
                             url: &quot;/PGCTechnologyServices/course-manager/deleteinstructor?instructor_id=&quot;+id+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                              beforeSend:function() {
            ...
            $(&quot;#ins_email&quot;).change(function(e) {
                ...
                if($('[name=&quot;txtInstructor_id&quot;]').val()==''){
                      ...
                      $.ajax({
                             ...
                             cache: false,
                             timeout:60000,
                             url: &quot;/PGCTechnologyServices/course-manager/getinstructordatabyemail?email=&quot;+$('#ins_email').val()+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                              beforeSend:function() {
                ...
                //waitingDialog.show('Loading....');
                        ...
                        if($('[name=&quot;txtInstructor_id&quot;]').val()!=''){
                                 ...
                                 $.ajax({
                                        ...
                                        cache: false,
                                        timeout:60000,
                                        url: &quot;/PGCTechnologyServices/course-manager/getinstructordata?client_id=&quot;+$('[name=&quot;txtInstructor_id&quot;]').val()+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                         beforeSend:function() {
                    ...
                    if ($(&quot;#frm_submit_instructor&quot;).valid()) {
                            ...
                            var datastring = serialized;
                             $.ajax({
                                 ...
                                 cache: false,
                                 timeout:60000,
                                 url: &quot;/PGCTechnologyServices/course-manager/addinstructor?sid=kcuc48ja&amp;time=&quot;+new Date().getTime(),
                                 data: datastring,
                                 beforeSend:function() {
                            ...
                             General Information 
                                 ...
                                 $( &quot;#txtmoodle_shortnmae&quot; ).change(function() {
                                      ...
                                      $.ajax({
                                          ...
                                          cache: false,
                                          timeout:60000,
                                          url: &quot;/PGCTechnologyServices/course-manager/ismoodleclassexist?moodleShortname=&quot;+$( &quot;#txtmoodle_shortnmae&quot; ).val()+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                          beforeSend:function() {
                                 ...
                                 $( &quot;#txtcanvas_courseid&quot; ).change(function() {
                                      ...
                                      $.ajax({
                                          ...
                                          cache: false,
                                          timeout:60000,
                                          url: &quot;/PGCTechnologyServices/course-manager/iscanvasclassexist?canvas_course_id=&quot;+$( &quot;#txtcanvas_courseid&quot; ).val()+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                          beforeSend:function() {
                                                ...
                                                if ($(&quot;#frm_schedule&quot;).valid()) {
                                                    ...
                                                    var datastring = serialized;
                                                     $.ajax({
                                                         ...
                                                         cache: false,
                                                         timeout:60000,
                                                         url: &quot;/PGCTechnologyServices/course-manager/generatedays?MAXDATES_CAL=50&amp;sure=0&amp;sid=kcuc48ja&amp;classid=0&amp;btn_generate_date=&quot;+hdn_schedule_change+&quot;&amp;time=&quot;+new Date().getTime(),
                                                         data: datastring,
                                                         beforeSend:function() {
                                                            waitingDialog.hide();
                                                            $('#ajax_instr_loader').hide();
                                                                   ...
                                                                   //waitingDialog.show('Loading....');
                                                                    ...
                                                                    var datastring = serialized;
                                                                     $.ajax({
                                                                         ...
                                                                         cache: false,
                                                                         timeout:60000,
                                                                         url: &quot;/PGCTechnologyServices/course-manager/generatedays?classid=0&amp;MAXDATES_CAL=50&amp;sure=1&amp;sid=kcuc48ja&amp;classid=0&amp;btn_generate_date=&quot;+hdn_schedule_change+&quot;&amp;time=&quot;+new Date().getTime(),
                                                                         data: datastring,
                                                                          beforeSend:function() {
                                                                            waitingDialog.hide();
                                                                            $('#ajax_instr_loader').hide();
                                                                         ...
                                                                         success: function(data) {
                                                                              ...
                                                                              $.ajax({
                                                                                ...
                                                                                cache: false,
                                                                                timeout:60000,
                                                                                url: &quot;/PGCTechnologyServices/course-manager/trainingyearset?classid=0&amp;sid=kcuc48ja&amp;classid=0&amp;btn_generate_date=&quot;+hdn_schedule_change+&quot;&amp;time=&quot;+new Date().getTime()+'&amp;tdate='+$(&quot;#generate_start_date&quot;).val()+'&amp;tedate='+$(&quot;#generate_end_date&quot;).val(),
                                                                                data: {},
                                                                                 beforeSend:function() {
                                                                                   waitingDialog.hide();
                                                                                   $('#ajax_instr_loader').hide();
                                            ...
                                            $(&quot;#cboPubOption&quot;).change(function(e) {
                                                  ...
                                                  //waitingDialog.show('Loading....');
                                                            ...
                                                            $.ajax({
                                                               ...
                                                               cache: false,
                                                               timeout:60000,
                                                               url: &quot;/PGCTechnologyServices/course-manager/puboptchange?cboPubOption=&quot;+this.value+&quot;&amp;ascDoNotPublish=01/01/2039&amp;sid=kcuc48ja&amp;time=&quot;+new Date().getTime() ,
                                                               dataType: &quot;json&quot;,
                                                                beforeSend:function() {
                                                                    waitingDialog.hide();
                                                                    $('#ajax_instr_loader').hide();
                              ...
                               RestrictionsTarget Audience
                                ...
                                function loadTracks(){
                                       ...
                                       var class_id=0;
                                        ...
                                        cache: false,
                                        timeout:60000,
                                        url: &quot;/PGCTechnologyServices/course-manager/gettracks?class_id=&quot;+class_id+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                         beforeSend:function() {
                            ...
                            if (r == true) {
                                    ...
                                    //waitingDialog.show('Loading....');
                                     $.ajax({
                                         ...
                                         cache: false,
                                         timeout:60000,
                                         url: &quot;/PGCTechnologyServices/course-manager/deletefocusarea?focus_id=&quot;+id+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                          beforeSend:function() {
                                    ...
                                    //waitingDialog.hide();
                                     ...
                                     var datastring = serialized;
                                      $.ajax({
                                          ...
                                          cache: false,
                                          timeout:60000,
                                          url: &quot;/PGCTechnologyServices/course-manager/addfocusarea?sid=kcuc48ja&amp;time=&quot;+new Date().getTime(),
                                          data: datastring,
                                           beforeSend:function() {
                            ...
                            if (r == true) {
                                    ...
                                    //waitingDialog.show('Loading....');
                                     $.ajax({
                                         ...
                                         cache: false,
                                         timeout:60000,
                                         url: &quot;/PGCTechnologyServices/course-manager/deletedate?date_id=&quot;+id+'&amp;sid=kcuc48ja&amp;time'+new Date().getTime(),
                                         beforeSend:function() {
                             ...
                             if ($(&quot;#frm_add_date&quot;).valid()) {
                                     ...
                                     var datastring = serialized;
                                      $.ajax({
                                          ...
                                          cache: false,
                                          timeout:60000,
                                          url: &quot;/PGCTechnologyServices/course-manager/adddate?sid=kcuc48ja&amp;time=&quot;+new Date().getTime(),
                                          data: datastring,
                                           beforeSend:function() {
                            ...
                            if (r == true) {
                                    ...
                                    //waitingDialog.show('Loading....');
                                     $.ajax({
                                         ...
                                         cache: false,
                                         timeout:60000,
                                         url: &quot;/PGCTechnologyServices/course-manager/deletetargetaudience?id=&quot;+id+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                          beforeSend:function() {
                                    ...
                                    //waitingDialog.hide();
                                     ...
                                     var datastring = serialized;
                                      $.ajax({
                                          ...
                                          cache: false,
                                          timeout:60000,
                                          url: &quot;/PGCTechnologyServices/course-manager/addtargetaudience?sid=kcuc48ja&amp;time=&quot;+new Date().getTime(),
                                          data: datastring,
                                           beforeSend:function() {
                  ...
                  $('#frm_restriction_add').validate({
                            ...
                            if (r == true) {
                                    ...
                                    //waitingDialog.show('Loading....');
                                     $.ajax({
                                         ...
                                         cache: false,
                                         timeout:60000,
                                         url: &quot;/PGCTechnologyServices/course-manager/deletegroup?group_id=&quot;+id+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                          beforeSend:function() {
                       ...
                       $(&quot;#txtClassEnrollGroupName1&quot;).change(function(e) { 
                            ...
                            $.ajax({
                                    ...
                                    cache: false,
                                    timeout:60000,
                                    url: &quot;/PGCTechnologyServices/course-manager/checkgroup?groupname=&quot;+ $(&quot;#txtClassEnrollGroupName&quot;).val()+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                    beforeSend:function() {
                                    ...
                                    //waitingDialog.hide();
                                     ...
                                     var datastring = serialized;
                                      $.ajax({
                                          ...
                                          cache: false,
                                          timeout:60000,
                                          url: &quot;/PGCTechnologyServices/course-manager/addgroup?sid=kcuc48ja&amp;time=&quot;+new Date().getTime(),
                                          data: datastring,
                                          beforeSend:function() {
                        ...
                        function loadRubricComponents(){
                            ...
                            var domain=$(&quot;#Domain&quot;).val();
                              ...
                              $.ajax({
                                   ...
                                   cache: false,
                                   timeout:60000,
                                   url: &quot;/PGCTechnologyServices/course-manager/filllevel3?rubric=&quot; + Rubrics+'&amp;gradecluster='+domain+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                   data: {},
                                   beforeSend:function() {
                                            ...
                                            //waitingDialog.hide();
                                             ...
                                             var datastring = serialized;
                                              $.ajax({
                                                  ...
                                                  cache: false,
                                                  timeout:60000,
                                                  url: &quot;/PGCTechnologyServices/course-manager/addrubric?sid=kcuc48ja&amp;time=&quot;+new Date().getTime(),
                                                  data: datastring,
                                                  beforeSend:function() {
                                                    waitingDialog.hide();
                                                    $('#ajax_instr_loader').hide();
                         ...
                         $(&quot;#Rubrics&quot;).change(function(e) {
                            ...
                            $.ajax({
                               ...
                               cache: false,
                               timeout:60000,
                               url: &quot;/PGCTechnologyServices/course-manager/fillgradecluster?rubric=&quot; + $(&quot;#Rubrics&quot;).val()+'&amp;selected='+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                               data: {},
                               beforeSend:function() {
                                    waitingDialog.hide();
                                    $('#ajax_instr_loader').hide();
                            ...
                            if (r == true) {
                                    ...
                                    //waitingDialog.show('Loading....');
                                     $.ajax({
                                         ...
                                         cache: false,
                                         timeout:60000,
                                         url: &quot;/PGCTechnologyServices/course-manager/deleterubric?id=&quot;+id+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                         beforeSend:function() {
                    ...
                    function isInt(value) {
                     ...
                     $('.table_body').on('click', '.edit_question', function(e) {
                            ...
                            if($(&quot;#followup_or_survey&quot;).val()==&quot;survey&quot;){
                               ...
                               var url_=&quot;/PGCTechnologyServices/course-manager/getquestioninfo?id=&quot;+id+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime();
                                 
                             }
                             else{
                                 
                                  var url_=&quot;/PGCTechnologyServices/course-manager/getquestioninfofollowup?id=&quot;+id+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime();
                             }
                     ...
                     $('.table_body').on('click', '.delete_question', function(e) { 
                            ...
                            if($(e.target).hasClass('followup_que')){
                             ...
                             if($(&quot;#followup_or_survey&quot;).val()==&quot;survey&quot;){
                               ...
                               var url_=&quot;/PGCTechnologyServices/course-manager/deletequestion?id=&quot;+id+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime()
                                 
                             }
                             else{
                                 
                                  var url_=&quot;/PGCTechnologyServices/course-manager/deletequestionfollowup?id=&quot;+id+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime()
                             }
                    ...
                    function resetAddQuestionForm(){
                     ...
                     $( &quot;#btn_submit_question&quot; ).click(function(e) {
                           ...
                           if($(&quot;#followup_or_survey&quot;).val()==&quot;survey&quot;){
                               ...
                               var url_=&quot;/PGCTechnologyServices/course-manager/addquestion?sid=kcuc48ja&amp;time=&quot;+new Date().getTime();
                                 
                             }
                            else{
                                
                                
                                var url_=&quot;/PGCTechnologyServices/course-manager/addquestionfollowup?sid=kcuc48ja&amp;time=&quot;+new Date().getTime();
                            } 
                    ...
                    Calculate Based On Enrollment
                            ...
                            $('.table_body').on('click', '.edit_accounting', function(e) {
                                    ...
                                    $.ajax({
                                         ...
                                         cache: false,
                                         timeout:60000,
                                         url: &quot;/PGCTechnologyServices/course-manager/getsingleaccouting?id=&quot;+exid+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                         datatype:'json',
                                          beforeSend:function() {
                            ...
                            if (r == true) {
                                    ...
                                    //waitingDialog.show('Loading....');
                                     $.ajax({
                                         ...
                                         cache: false,
                                         timeout:60000,
                                         url: &quot;/PGCTechnologyServices/course-manager/deleteaccouting?id=&quot;+exid+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                          beforeSend:function() {
                           ...
                           $(&quot;#cboFiscalYear_text&quot;).val($(&quot;#cboFiscalYear option:selected&quot;).text());
                            ...
                            var datastring = serialized;
                             $.ajax({
                                 ...
                                 cache: false,
                                 timeout:60000,
                                 url: &quot;/PGCTechnologyServices/course-manager/addaccounting?sid=kcuc48ja&amp;time=&quot;+new Date().getTime(),
                                 data: datastring,
                                  beforeSend:function() {
                ...
                Wizard Complete!
                    ...
                    $(&quot;#btn_final_save&quot;).click(function(e) {
                            ...
                            $.ajax({
                                  ...
                                  cache: false,
                                  timeout:60000,
                                   url: &quot;/PGCTechnologyServices/course-manager/finalclassstatus?cgApproval=&amp;classId=0&amp;cgApprovalPosted=&quot;+radioValue+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                   beforeSend:function() {
        ...
        function changeCategory(is_reload_other_pref_data){
            ...
            $('#CourseTypeCbo').empty();
                ...
                $.ajax({
                    ...
                    cache: false,
                    timeout:60000,
                    url: &quot;/PGCTechnologyServices/course-manager/getcoursetypes?category=&quot; + $(&quot;#cboCategory&quot;).val()+'&amp;selected=&amp;sid=kcuc48ja&amp;is_reload_other_pref_data='+is_reload_other_pref_data+'&amp;time='+new Date().getTime(),
                    data: {},
                    dataType: &quot;JSON&quot;,
        ...
        $(document).ready(function () {
           ...
           function displayComponentName(){
             ...
             $.ajax({
                        ...
                        cache: false,
                        timeout:60000,
                        url: &quot;/PGCTechnologyServices/course-manager/getcomponentname?num1=&quot;+$.trim($(&quot;#Num1&quot;).val())+&quot;&amp;num2=&quot;+$.trim($(&quot;#Num2&quot;).val())+&quot;&amp;num3=&quot;+$.trim($(&quot;#Num3&quot;).val())+&quot;&amp;catid=&quot; + $(&quot;#cboCategory&quot;).val()+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                         beforeSend:function() {
                             waitingDialog.hide();
                             $('#ajax_instr_loader').hide();
                             waitingDialog.show('Loading....');
           ...
           function calculatDeadLines(){
               ...
               var classid=0;
                   ...
                   cache: false,
                   timeout:60000,
                   url: &quot;/PGCTechnologyServices/course-manager/calcdeadlines?classid=&quot;+classid+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                   dataType: &quot;json&quot;,
                   beforeSend:function() {
           ...
           function saveDataToSession(tabindex){
               ...
               //var datastring = $(finddiv).find('form').serialize();
                ...
                $.ajax({
                    ...
                    timeout:60000,
                    async: false,
                    url: &quot;/PGCTechnologyServices/course-manager/savedatatosession?sid=kcuc48ja&amp;time=&quot;+new Date().getTime(),
                    data: datastring,
                    dataType: &quot;json&quot;,
                    beforeSend:function() {
                                            ...
                                            if (r == true) {
                                                ...
                                                if(lastIndex==7){
                                                      ...
                                                      $.ajax({
                                                                ...
                                                                cache: false,
                                                                timeout:60000,
                                                                url: &quot;/PGCTechnologyServices/course-manager/processedroster?classId=0&amp;numMaxClassSize=&quot;+$(&quot;#numMaxClassSize&quot;).val()+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                                                                data: datastring,
                                                                dataType: &quot;json&quot;,
                                                                beforeSend:function() {
            ...
            $('#btnPrevStep').click(function () {
                ...
                return false;
                     ...
                     $.ajax({
                                    ...
                                    cache: false,
                                    timeout:60000,
                                    url: &quot;/PGCTechnologyServices/course-manager/finishddcourse?sid=kcuc48ja&amp;time=&quot;+new Date().getTime(),
                                    dataType: &quot;json&quot;,
                                    beforeSend:function() {
                                    ...
                                    success: function(data) {
                                         ...
                                         if(data.is_sucess==&quot;false&quot;){
                                            ...
                                            alert(&quot;Error while creating course&quot;);
                                                ...
                                                finish_success=true;
                                                window.location.href='/PGCTechnologyServices/course-manager/update?class_id='+data.course_id+'&amp;sid=kcuc48ja&amp;time='+new Date().getTime();
                                            }
                ...
                if ($('option:selected', this).text() == 'Other') {
                    ...
                    $('#cboCourseLocRoom').empty();
                     ...
                     $.ajax({
                        ...
                        cache: false,
                        timeout:60000,
                        url: &quot;/PGCTechnologyServices/course-manager/fillcourselocroomcbo?Loc=&quot; + $(&quot;#cboCourseLocation&quot;).val()+'&amp;selected=&amp;sid=kcuc48ja&amp;time='+new Date().getTime(),
                         beforeSend:function() {
                             waitingDialog.hide();
                             $('#ajax_instr_loader').hide();
                             waitingDialog.show('Loading....');
    ...
    window.onbeforeunload = function (e) {
       ...
       if(finish_success==false){
        ...
        var finddiv=$(&quot;div&quot;).find(&quot;[data-tabindex='&quot; + tabindex + &quot;']&quot;);
            ...
            var datastring = $(finddiv).find('form').serialize();
             $.ajax({
                 ...
                 cache: false,
                 async: false,
                 url: &quot;/PGCTechnologyServices/course-manager/savedatatosession?sid=kcuc48ja&quot;,
                 data: datastring,
                 dataType: &quot;json&quot;,
                 success: function(data) {
        ...
        $.ajax({
                ...
                cache: false,
                async: false,
                url: &quot;/PGCTechnologyServices/course-manager/finishddcourse?sid=kcuc48ja&quot;,
                success: function(data) {
               //   alert('hi'); 
                },
                 error: function (xhr, ajaxOptions, thrownError) {
